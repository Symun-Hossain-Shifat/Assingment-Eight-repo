...
* the user can login or register this website by his google automatically
* the user can update his profile info by adding information about his
* the user cannot see the profile page link if he dose not login this page .after login the profile url is visible
* the user cannot register in this page another time by same email
* the user can booked a animal for qurbani
