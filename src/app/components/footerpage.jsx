...
<div className='space-y-2'>
  <p className='flex items-center gap-1 text-[15px]'> <IoCallOutline size={20}/> +880 01615050716</p>
<p className='flex items-center gap-1 text-[15px]'> <MdOutlineEmail size={20}/> kurbaneidhat@gamil.com</p>
<p className='flex items-center gap-1 text-[15px]'> <SlLocationPin size={20}/> Rampura , Dhaka</p>
